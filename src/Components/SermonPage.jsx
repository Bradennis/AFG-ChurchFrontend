...
const SermonPage = () => {
  ...
  const handleSermonClick = (id, sermon) => {
    navigate(`/sermon/${id}`, { state: { sermon } });
  };
        ...
        {filteredSermons.length > 0 ? (
          filteredSermons.map((sermon) => (
            <div
              ...
              onClick={() => handleSermonClick(sermon._id, sermon)}
            ...
            >
              ...
              <div className='event-details'>
                <h3>{sermon.title}</h3>
                <h5>Sermon By: {sermon.speaker}</h5>
